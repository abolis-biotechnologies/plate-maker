(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('ngx-drag-to-select'), require('ng2-tooltip-directive'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@abolis/plate-maker', ['exports', '@angular/common', 'ngx-drag-to-select', 'ng2-tooltip-directive', '@angular/core'], factory) :
    (factory((global.abolis = global.abolis || {}, global.abolis['plate-maker'] = {}),global.ng.common,global['ngx-drag-to-select'],global.ng2TooltipDirective,global.ng.core));
}(this, (function (exports,common,ngxDragToSelect,ng2TooltipDirective,core) { 'use strict';
